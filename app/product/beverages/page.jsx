 ...
 return (
  <div className="flex flex-col gap-10 overflow-x-auto lg:overflow-y-auto w-full max-h-[300px] lg:max-h-[450px] px-5">
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{coffee.name}</h1>
   ...
   {/*milk*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{milk.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
   ...
   {/*yakult*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{yakult.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
   ...
   {/*tea*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{tea.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
   ...
   {/*mocktail*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{mocktail.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
   ...
   {/*mojito*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{mojito.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
   ...
   {/*others*/}
   <div className="flex flex-col gap-4 ">
    <h1 className="text-gray-400 text-2xl font-bold">{others.name}</h1>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
